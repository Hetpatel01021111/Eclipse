...
```json
{
  ...
  "trigger": { "type": "manual", "label": "🔒 Run Security Check" },
  "action": {
    "type": "message",
...
├── design.md          # How to build (architecture, security)
...
### Submitting For:
- ✅ **Best Use of Kiro Features** - Comprehensive use of specs, hooks, steering
- ✅ **Best Privacy/Security Project** - Zero-knowledge encrypted messenger
